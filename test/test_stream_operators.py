...
def test_delay() -> None:
    ...
    delayed_s = step_until_timestamp_and_return(operator, s.current_time() + 1)
...
def test_lifted_group_negate() -> None:
    ...
    negated_s = step_until_timestamp_and_return(operator, s.current_time())
...
def test_lifted_group_add() -> None:
    ...
    doubled_s = step_until_timestamp_and_return(operator, s.current_time())
...
def test_differentiate() -> None:
    ...
    diffed_s = step_until_timestamp_and_return(operator, s.current_time())
...
def test_lifted_delay() -> None:
    ...
    delayed_s = step_until_timestamp_and_return(operator, s.current_time())
...
def test_lifted_stream_introduction_and_elimination() -> None:
    ...
    step_until_timestamp_and_return(intro_operator, n)

    elim_operator: LiftedStreamElimination[int] = LiftedStreamElimination(intro_operator.output_handle())
    step_until_timestamp_and_return(elim_operator, n)
